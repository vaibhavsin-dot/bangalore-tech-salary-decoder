...
```bash
git clone https://github.com/vaibhavsin-dot/bangalore-tech-salary-decoder.git
...
---
**Vaibhav Singh** | [LinkedIn](https://www.linkedin.com/in/vaibhav-singh-587525331) | [GitHub](https://github.com/vaibhavsin-dot)
